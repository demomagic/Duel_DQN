...
import numpy as np
import argparse
from agent_duelingDQN import Agent,process_observation

def main():
    parse = argparse.ArgumentParser(description="dueling DQN model train")
    parse.add_argument("--episode", help="training frequency", type = int, default=10000)
    parse.add_argument("--env_name", help="game name", default='Solaris-v0')
    parse.add_argument("--model_type", help="'dueldqn' is dueling_DQN, 'duelddqn' is dueling_DDoubleQN", default='duelddqn')
